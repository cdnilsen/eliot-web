...
// Build lookup maps
const hebrewConsonantInputToInternal = {};
const hebrewVowelInputToInternal = {};
const hebrewInternalToOutput = {};
...
// Build tries
function hebrewTrieInsert(str, stringCursor, treeCursor) {
...
function constructHebrewTrie(strs) {
...
function getNextHebrewToken(str, trie, startingIndex) {
...
function maximumMunchTokenizeHebrew(str) {
    let strCursor = 0;
    const tokens = [];
...
function renderHebrew(tokens, includeNiqqud, isEndOfWord) {
    let result = "";
...
function determineWordBoundaries(tokens) {
...
export function transliterateHebrew(str, includeNiqqud = false) {
...
export const hebrewSpecialChars = [
    "ā", "ē", "ī", "ō", "ū", "ă", "ĕ", "ŏ", "å", "ḥ", "ṭ", "ṣ", "š", "ś", "ʾ", "ʿ", "·"
];
export function hebrewDiacriticify(str, isASCII) {
    if (isASCII) {
        const ASCII2DiacriticDict = {
            "H": "ḥ", // ח
            "T": "ṭ", // ט  
            "S": "ṣ", // צ
            "Q": "q", // ק
...
//# sourceMappingURL=transcribe_hebrew.js.map